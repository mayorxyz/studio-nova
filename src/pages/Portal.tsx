      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <BentoCard variant="dark">
          ...
          <div className="space-y-2">
            <Link to="/portal/projects" className="block px-4 py-3 border border-[var(--muted)] text-[var(--base)] hover:border-[var(--safety)] hover:text-[var(--safety)] transition-colors text-sm">
              → View All Projects
            </Link>
            <Link to="/portal/invoices" className="block px-4 py-3 border border-[var(--muted)] text-[var(--base)] hover:border-[var(--safety)] hover:text-[var(--safety)] transition-colors text-sm">
              → View Invoices
            </Link>
            <Link to="/portal/messages" className="block px-4 py-3 border border-[var(--muted)] text-[var(--base)] hover:border-[var(--safety)] hover:text-[var(--safety)] transition-colors text-sm">
              → Check Messages
            </Link>
            <Link to="/portal/settings" className="block px-4 py-3 border border-[var(--muted)] text-[var(--base)] hover:border-[var(--safety)] hover:text-[var(--safety)] transition-colors text-sm">
              → Account Settings
            </Link>
          </div>
        </BentoCard>
